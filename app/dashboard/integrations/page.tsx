...
const SERVICES: Service[] = [
  {
    ...
    cat: 'コミュニケーション', status: 'connected',
    synced: 1284, last: '5分前',
    path: '/dashboard/integrations/line',
    metrics: [
      { label: '友だち数', value: '2,847' },
      { label: '今月の配信', value: '1,284' },
      { label: '到達率', value: '98.7%' },
      { label: '予約コンバージョン', value: '42.1%' },
    ],
    settings: [
      { label: '公式アカウントID', value: '@kirei-tsurumi', editable: true },
      { label: 'Webhook URL', value: 'https://api.salonrink.../line/wh' },
      { label: 'リマインド配信', value: '前日 18:00', toggle: true, on: true },
      { label: '来店後フォロー', value: '翌日 11:00', toggle: true, on: true },
      { label: '自動応答ルール', value: '8件 設定済み' },
    ],
  },
  {
    ...
    cat: '予約', status: 'connected',
    synced: 342, last: '12分前',
    path: '/dashboard/integrations/hotpepper',
    metrics: [
      { label: '今月の取り込み', value: '342件' },
      { label: '同期周期', value: '30分' },
      { label: '重複検出', value: '12件' },
      { label: '成功率', value: '99.4%' },
    ],
    settings: [
      { label: '店舗ID', value: 'kirei-tsurumi-001' },
      { label: '同期周期', value: '30分', editable: true },
      { label: '自動取り込み', value: '有効', toggle: true, on: true },
      { label: '重複時の処理', value: '手動確認', editable: true },
    ],
  },
  {
    ...
    cat: 'コミュニケーション', status: 'configured',
    synced: null, last: '昨日',
    path: '/dashboard/integrations/richmenu',
    metrics: [
      { label: 'メニュー枠', value: '6 / 6' },
      { label: 'タップ数 / 日', value: '128' },
    ],
    settings: [
      { label: '現在のテンプレート', value: '春キャンペーン' },
      { label: '公開状態', value: '公開中', toggle: true, on: true },
      { label: '最終更新', value: '昨日 14:32' },
    ],
  },
  {
