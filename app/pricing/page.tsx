    ...
    >
      ...
      <article style={{ maxWidth: 1100, margin: '0 auto', padding: '60px 24px 80px' }}>
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          <h1 style={{ fontSize: 40, fontWeight: 300, letterSpacing: 3, color: '#1A1018', marginBottom: 16 }}>
            料金プラン
          </h1>
          <p style={{ fontSize: 16, color: '#7A6E64', fontFamily: 'sans-serif', lineHeight: 1.8 }}>
            サロンの規模・ご予算にあわせて、最適なプランをお選びいただけます。
            <br />
        ...
        >
          {plans.map((p) => (
            ...
            >
              ...
              <div style={{ fontSize: 13, color: p.color, letterSpacing: 3, fontFamily: 'sans-serif', marginBottom: 12 }}>
                {p.name}
              </div>
        ...
        >
          <h2 style={{ fontSize: 22, fontWeight: 400, letterSpacing: 3, marginBottom: 24, color: '#3d2b1f' }}>
            機能比較
          </h2>
            ...
            <tbody>
              {features.map(([label, values]) => (
                <tr key={label as string} style={{ borderBottom: '1px solid #f0e7da' }}>
                  <td style={{ padding: '14px 16px', fontFamily: 'sans-serif', fontSize: 13 }}>
                    {label as string}
                  </td>
                  {(values as (boolean | string)[]).map((v, i) => (
                    <td
                      ...
                      style={{
                        ...
                        fontFamily: 'sans-serif',
                        fontSize: 13,
                        color: v === true ? '#7A3550' : v === '--' ? '#ccc' : '#5a4a3f',
                      }}
                    >
                      {v === true ? '✓' : v}
                    </td>
        ...
        <section style={{ marginBottom: 60 }}>
          <h2 style={{ fontSize: 22, fontWeight: 400, letterSpacing: 3, marginBottom: 20, color: '#3d2b1f' }}>
            よくあるご質問
          </h2>
          <div style={{ display: 'grid', gap: 12 }}>
            ...
            <p style={{ textAlign: 'center', marginTop: 16, fontSize: 13, color: '#7A6E64', fontFamily: 'sans-serif' }}>
              他にご質問があれば <a href="/faq" style={{ color: '#B8966A' }}>FAQ一覧</a> または{' '}
              <a href="/contact" style={{ color: '#B8966A' }}>お問い合わせ</a> からどうぞ
            </p>
          </div>
        </section>
        ...
        >
          <h2 style={{ fontSize: 22, fontWeight: 400, letterSpacing: 3, marginBottom: 12 }}>
            まずは14日間無料でお試しください
          </h2>
