...
export default function FAQSection() {
  const faqs = [
    ...
    { q: 'AI機能とは何ですか？', a: 'SalonRinkのAI機能は、Claude Haikuを活用した美容師の頭脳を支える機能群です。AIカルテ（顧客サマリー自動生成）、AI接客スクリプト、AIアレルギー注意、AI次回提案の4つの機能で、お客様一人ひとりに最適な施術提案をサポートします。' },
    ...
    { q: 'AI機能の追加料金はかかりますか？', a: 'Coreプラン（¥1,980/月）にAI機能（顧客サマリー・基本接客スクリプト・アレルギー注意）が標準装備されています。さらに高度なAI機能（より精緻な分析・カスタムプロンプト）をご希望の場合は、AI ADD（+¥800/月）で拡張可能です。' },
  ]
